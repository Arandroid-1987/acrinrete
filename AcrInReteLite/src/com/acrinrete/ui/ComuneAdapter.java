...
public class ComuneAdapter extends ArrayAdapter<Notizia> {
	private TextView notiziaTitle;
	private TextView notiziaAuthor;

	private List<Notizia> items = new ArrayList<Notizia>();

	public ComuneAdapter(Context context, int textViewResourceId,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (row == null) {
			...
			row = inflater.inflate(R.layout.notizia_comune, parent, false);
		}
